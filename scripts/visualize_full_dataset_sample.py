...
CSV_PATH = "nuscenes_goal_tokens_refined.csv"
OUTPUT_DIR = "bev_frames_full_dataset_sample"
MAX_SCENES_TO_VISUALIZE = 20
# ==========================================
...
def main():
    ...
    # Select first 20 scenes
    selected_scenes = list(scene_rows.keys())[:MAX_SCENES_TO_VISUALIZE]
    print(f"Generating BEV frames for {len(selected_scenes)} sample scenes...")
